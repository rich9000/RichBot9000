...
@section('content')
    ...
    <div class="container mt-5 " style="background-color: antiquewhite">
        ...
        @endif
        <form action="{{ route('chat.assistants.store') }}" method="POST">
            @csrf
                ...
                <div>
                    ...
                    @foreach($onlineFiles as $file)
                        <div class="form-check">
                            @dump($file)
                            <input class="form-check-input" type="checkbox" name="onlineFiles[]" value="{{ $file['id'] }}" id="file_{{ $file['id'] }}">
                            <label class="form-check-label" for="file_{{ $file['id'] }}">{{ $file['filename'] }} {{ $file['id'] }}</label>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="download_file" id="download_file">
                        <label class="form-check-label" for="download_file">Download File</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_file" id="delete_file">
                        <label class="form-check-label" for="delete_file">Delete File</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_files" id="list_files">
                        <label class="form-check-label" for="list_files">List Files</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_folders" id="list_folders">
                        <label class="form-check-label" for="list_folders">List Folders</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="create_directory" id="create_directory">
                        <label class="form-check-label" for="create_directory">Create Directory</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_directory" id="delete_directory">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="append_text" id="append_text">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="send_email" id="send_email">
                ...
                <div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_users" id="list_users">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_user" id="delete_user">
                        <label class="form-check-label" for="delete_user">Delete User</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_projects" id="list_projects">
                        <label class="form-check-label" for="list_projects">List Projects</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="add_project" id="add_project">
                        <label class="form-check-label" for="add_project">Add Project</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="view_project" id="view_project">
                        <label class="form-check-label" for="view_project">View Project</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_project" id="delete_project">
                        <label class="form-check-label" for="delete_project">Delete Project</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_goals" id="list_goals">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_goal" id="delete_goal">
                        <label class="form-check-label" for="delete_goal">Delete Goal</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_tasks" id="list_tasks">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_task" id="delete_task">
                        <label class="form-check-label" for="delete_task">Delete Task</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_issues" id="list_issues">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="view_issue" id="view_issue">
                        <label class="form-check-label" for="view_issue">View Issue</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_issue" id="delete_issue">
                        <label class="form-check-label" for="delete_issue">Delete Issue</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="list_deadlines" id="list_deadlines">
                        <label class="form-check-label" for="list_deadlines">List Deadlines</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="add_deadline" id="add_deadline">
                        <label class="form-check-label" for="add_deadline">Add Deadline</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="view_deadline" id="view_deadline">
                        <label class="form-check-label" for="view_deadline">View Deadline</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="functions[]" value="delete_deadline" id="delete_deadline">
